...
public class GameSaveData
{
    ...
    /// <summary>Сцены, для которых уже выполнялось автосохранение в этом слоте (кроме лобби).</summary>
    public List<string> autoSavedScenes = new List<string>();
    ...
    public GameSaveData(int slotIndex)
    {
        ...
        autoSavedScenes = new List<string>();
    }
